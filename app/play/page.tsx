    ...
    return (
        <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
            ...
            <div className="ml-10 mr-10 animate-fade-in grid justify-center">
                ...
                <h2 className="my-8 text-xl text-white text-center cursor-default text-edge-outline animate-title font-display">
                    Youtube title videos here
                </h2>
                <center className="flex text-white text-lg font-display w-[12vw] h-[4vw] bg-red-500 mb-5 rounded-lg place-self-center">
                    <div className="text-center m-auto">
                        {getGuessedDate(sliderVal)}
                    </div>
                </center>
